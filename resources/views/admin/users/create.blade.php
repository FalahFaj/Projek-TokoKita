...
@section('title', 'Tambah User - TokoKita')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="small text-muted mb-0">
                                <li>Mengelola produk, kategori, supplier</li>
                                <li>Melihat laporan dan statistik</li>
                                <li>Mengelola stok dan inventory</li>
                                <li>Tidak bisa mengelola user lain</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <h6>Kasir</h6>
                            <ul class="small text-muted mb-0">
                                <li>Melakukan transaksi POS</li>
                                <li>Melihat riwayat transaksi sendiri</li>
                                <li>Tidak bisa akses menu admin</li>
                                <li>Akses terbatas pada fitur tertentu</li>
                            </ul>
                        </div>
                    </div>
                </div>
